  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow p-4 space-y-4">
      ...
      <div>
        ...
        {q.questionHtml && (
          <div
            className="border border-gray-200 rounded-md p-2 mb-2 bg-white overflow-auto"
            data-testid="question-html"
      ...
      <div className="bg-gray-50 rounded-lg p-2 border border-gray-100">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
          {[
            ...
            {
              icon: <MinusCircle size={13} className="text-red-500" />,
              label: "Neg",
              name: "negativeMarks",
              type: "number",
              placeholder: "0",
            ...
            <div key={item.name} className="flex flex-col">
              ...
              <input
                ...
                className="border border-gray-300 rounded-md px-1 py-1 text-xs shadow-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-100 transition"
      ...
      <div>
        ...
        {q.solutionHtml && (
          <div
            ...
            dangerouslySetInnerHTML={{ __html: q.solutionHtml }}
          />
        )}
        <textarea
          value={q.solution}
